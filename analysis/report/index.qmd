...
I did not really appreciate how much structural decision-making goes into a textbook until I tried to draft two of them at once. A methods volume ('Statistical Computing in the Age of AI', for PHB 228 at UCSD) and a workflow companion ('Biostatistics Practicum', for PHB 243B) were both overdue, and I wanted them to share enough scaffolding that a student could move between them without reorienting.
...
- UCSD biostatistics MS students arrive with LLMs already in hand. Pretending otherwise produces a textbook that does not match their reading context.
...
1. Scaffold two Quarto books (PHB 228 methods, PHB 243B practicum) with compatible chapter structure, shared citation conventions, and visually distinct rendering.
...
The methods volume (228) covers statistical-theory content an MS programme teaches in a typical one-quarter course: programming in R, numerical linear algebra, optimisation, simulation, bootstrap, linear models, GLM, mixed models, survival, Bayesian. The practicum (243B) covers Jenny Bryan's 'everything in data analysis except modelling and inference': reproducibility infrastructure, Git, Docker, rrtools, renv, Quarto, tidyverse wrangling, CDISC data standards, SAS, and two full case studies.
...
- Methods volume: `~/Dropbox/prj/tch/01-phb228-stat-computing/phb228-2026/textbook/`
- Practicum volume: `~/Dropbox/prj/tch/biostatistics-practicum/`
